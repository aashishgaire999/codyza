      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ background: `radial-gradient(600px circle at 50% -100px, ${project.color}44, transparent 60%)` }}
          />
          <div className="relative p-6 md:p-8">
            ...
            <div className="flex gap-3">
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-white/[0.07]"
              >
              ...
              <a href={project.preview}
                ...
                style={{ background: `linear-gradient(135deg, ${project.color}, #3b82f6)` }}
              >
    ...
    <section id="projects" className="relative scroll-mt-32 border-t border-white/[0.04] bg-[#050508] py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.6 }} className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-zinc-400">Click any project to see the full details, tech stack, and team.</p>
        </motion.div>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-5 flex items-center justify-between border-t border-white/[0.06] pt-4">
                  ...
                  <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-600 group-hover:text-zinc-400 transition-colors">View details →</span>
                </div>
              </div>
            </motion.div>
          ))}
