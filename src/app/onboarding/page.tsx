...
export default function OnboardingPage() {
  ...
  if (loading) return (
    <div className="flex min-h-screen items-center justify-center text-white" style={{background:"linear-gradient(135deg,#0f0c1a,#130d24,#0c1220)"}}>
      <div className="text-gray-400">Loading...</div>
    </div>
  )

  if (success) return (
    <div className="flex min-h-screen items-center justify-center p-4 text-white" style={{background:"linear-gradient(135deg,#0f0c1a,#130d24,#0c1220)"}}>
